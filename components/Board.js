 ...
 class Board {
     ...
     movePlayer(direction) {
            if (direction === 'left' && this.player.y > 0) {
                this.board[this.player.x][this.player.y] = null;
                this.player.y--;
                this.setPlayer();
            }
            else if (direction === 'right' && this.player.y < this.boardSize - 1) {
                this.board[this.player.x][this.player.y] = null;
                this.player.y++;
                this.setPlayer();
            }
            else if (direction === 'up' && this.player.x > 0) {
                this.board[this.player.x][this.player.y] = null;
                this.player.x--;
                this.setPlayer();
            }
            else if (direction === 'down' && this.player.x < this.boardSize - 1) {
                this.board[this.player.x][this.player.y] = null;
                this.player.x++;
                this.setPlayer();
            }
